...
class Ping_Ball(GameSprite):
    ...
    def update(self):
        ...
        if self.rect.x + 40 >= Win_W:
            self.speed_x *= -1 
            self.hit_wall_sound.play()
            global score_p1_counter
            score_p1_counter += 1  

        if self.rect.y <=0 or self.rect.y + 40 >= Win_H:
            self.speed_y *= -1 
...
player_1 = Player(200, 200, 30, 100, 5, "Racket_1.png")
player_1.set_control(K_w, K_s, K_r)

player_2 = Player(600, 200, 30, 100, 5, "Racket_2.png")
...
p_ball = Ping_Ball(400, 250, 50, 50, 5, "ball_.png", )
